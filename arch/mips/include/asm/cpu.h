 ...
 */
#define PRID_IMP_PROCESSOR_ID_MSK	(0x7 << 13)
#define PRID_IMP_XBURST				(0x0 << 13)
#define PRID_IMP_UA					(0x1f << 8)
#define PRID_CPU_FEATURE_MASK		0xFFFF0000
#define PRID_CPU_JZ4775S			0x2ed10000	/*4775 M150 X1000*/
#define PRID_CPU_JZ4780				0x3ee10000
#define PRID_CPU_M200				0x7ae10000
